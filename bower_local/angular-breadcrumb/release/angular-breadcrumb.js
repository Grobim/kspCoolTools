            ...
            post: function postLink(scope) {
                ...
                var renderBreadcrumb = function() {
                    ...
                    angular.forEach(scope.steps, function (step) {
                        ...
                        prepareLabel(step, viewScope);

                    });

                    function prepareLabel(step, viewScope) {
                        if (step.ncyBreadcrumb && 
                                (
                                    step.ncyBreadcrumb.label ||
                                    (
                                        step.ncyBreadcrumb.translate &&
                                        _hasAngularTranslate
                                    )
                               )
                            ) {
                            if (step.ncyBreadcrumb.translate && _hasAngularTranslate) {
                                step.ncyBreadcrumbTranslate = true;
                            ...
                            step.ncyBreadcrumbLabel = step.label;
                        }
                    }
                };
